...
| サーバー再接続周期 | `50`                                                       | number | V1 | ブローカーサーバーへの接続が失敗した場合に再試行する周期を入力します。 | [Kafka公式ドキュメント](https://kafka.apache.org/23/configuration/consumer-configs/)の`reconnect.backoff.ms`プロパティ参照 |
