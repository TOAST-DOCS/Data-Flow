...
* V2 엔진 타입이 지원하는 노드를 추가했습니다.
    ...
    * Sink
        * Kafka
* S3, Object Storage Sink에 Parquet 코덱 추가
    * S3 및 Object Storage Sink 노드에서 Parquet 형식으로 데이터를 저장할 수 있는 코덱을 추가했습니다. 
...
### 2026. 02. 10.
#### 기능 개선/변경
*  V1 엔진에서 Cipher 노드 지원을 종료합니다.
    * 2026년 2월 10일부로 V1 엔진 타입의 Cipher 노드 기능 지원이 중단됩니다.
    * 기존 V1 엔진 타입 플로우에 Cipher 노드가 포함되어 있는 경우 플로우 실행이 불가능합니다.
